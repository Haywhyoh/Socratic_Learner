    ...
    def mentor_contract(
        ...
        *,
        ...
        prompt = (
            ...
            "sub-skill verified, and ask only for missing_required_evidence. If that list "
            "is empty, stop questioning and let the knowledge graph advance. You do not "
            "choose the next concept (callbacks → closures → objects is not automatic).\n"
